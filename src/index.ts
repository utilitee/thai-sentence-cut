...
/**
 * ฟังก์ชันใหม่สำหรับตัดคำและเพิ่ม Line Break
 */
export var splitThaiStringByLengthAndAddLineBreak = function (
  str: string,
  maxLength: number
): string {
    if(!maxLength){
    ...
    const splittedArray = splitThaiStringByLength(str, maxLength);
